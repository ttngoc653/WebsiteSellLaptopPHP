<div style="margin-top: 0px;">
	<a href="index.php?act=themsp"><button style="width: 200px">QUẢN LÝ SẢN PHẨM</button></a><?php
  ...
  ?><a href="index.php?act=qlngdung"><button style="width: 200px;">QUẢN LÝ NGƯỜI DÙNG</button></a><?php 
